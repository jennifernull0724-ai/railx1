      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-navy-900 mb-2">Document Review Option</h3>
            <p className="text-text-secondary">
              Sellers can opt into identity verification by submitting business documents for review.
            </p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 rounded-full bg-rail-orange/10 flex items-center justify-center mx-auto mb-4">
