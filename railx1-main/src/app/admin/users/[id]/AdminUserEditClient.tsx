  ...
  return (
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start gap-6">
            ...
            <div className="flex gap-2 flex-shrink-0">
              <button
                ...
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg transition-colors disabled:opacity-50 ${user.isActive ? "bg-red-100 text-red-700 hover:bg-red-200" : "bg-green-100 text-green-700 hover:bg-green-200"}`}
              >
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className={`font-medium capitalize ${user.sellerSubscriptionStatus === "active" ? "text-green-600" : user.sellerSubscriptionStatus === "trialing" ? "text-blue-600" : "text-gray-600"}`}>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-4 text-yellow-900 text-sm">
        <strong>Admin changes bypass automated billing and verification flows.</strong>
        <br />Use with caution. These changes take effect immediately and only apply to this user.
      </div>
          ...
          <div className="divide-y divide-gray-100">
            {listings.map((listing) => (
              ...
              >
                ...
                <span className={`px-3 py-1 text-xs font-medium rounded-full capitalize ${listing.status === "active" ? "bg-green-100 text-green-700" : listing.status === "pending" ? "bg-amber-100 text-amber-700" : "bg-gray-100 text-gray-700"}`}>
                  {listing.status}
                </span>
              </Link>
            ))}
