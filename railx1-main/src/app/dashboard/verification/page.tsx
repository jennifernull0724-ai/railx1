...
const VERIFICATION_OPTIONS: Record<string, VerificationOption> = {
  ...
  professional: {
    ...
    price: '$2,500/year or $1,500/5mo',
    priceNote: 'Annual prepay saves $2,000 vs installment',
    features: [
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-200">
                ...
                <th className="text-center py-3 px-4 font-medium text-rail-orange">Professional<br/><span className="text-xs font-normal">from $2,500/yr</span></th>
              </tr>
            </thead>
            <tbody>
