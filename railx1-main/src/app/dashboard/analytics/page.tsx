      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-surface-border p-12 text-center">
          ...
          <div className="bg-slate-50 rounded-lg p-4 mb-6 text-left max-w-md mx-auto">
            <p className="text-sm font-medium text-navy-900 mb-2">Professional Access</p>
            <p className="text-xs text-slate-500 mb-2">$2,500/year (best value) or $1,500 every 5 months</p>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-surface-border p-12 text-center">
          ...
          <p className="text-xs text-slate-400 mt-4">
            Analytics also included with Professional Access for contractors and companies.
          </p>
        </div>
      </div>
    );
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-surface-border p-12 text-center">
          ...
          <div className="text-left max-w-md mx-auto mb-6 space-y-3">
            ...
            <div className="p-3 bg-slate-50 rounded-lg">
              <p className="font-medium text-navy-900 text-sm">Contractors & Companies</p>
              <p className="text-xs text-slate-500">Included with Professional Access ($2,500/yr or $1,500/5mo)</p>
            </div>
          </div>
