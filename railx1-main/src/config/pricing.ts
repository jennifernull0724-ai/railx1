...
export interface ContractorTierConfig {
  ...
  priceInstallment?: number;  // in cents ($1,500 every 5 months)
  features: string[];
  stripePriceIdMonthly?: string;
  stripePriceIdYearly?: string;
  stripePriceIdInstallment?: string;  // Stripe price for installment billing
...
export const CONTRACTOR_TIER_CONFIG: Record<ContractorTier, ContractorTierConfig> = {
  ...
  // PRICING OPTIONS:
  // - Installment: $1,500 every 5 months (3 payments/year = $4,500/year total)
  // - Annual Prepay (Preferred): $2,500/year (discounted - saves $2,000/year)
  [CONTRACTOR_TIERS.PROFESSIONAL]: {
    id: CONTRACTOR_TIERS.PROFESSIONAL,
    name: 'Professional Verified',
    description: 'For contractors and companies. Annual prepay offers significant savings.',
    priceMonthly: 0, // No monthly option - installment is $1,500 every 5 months
    priceYearly: 250000, // $2,500.00/year (discounted annual prepay)
    priceInstallment: 150000, // $1,500.00 every 5 months (3 payments/year)
    features: [
    ...
    stripePriceIdYearly: process.env.STRIPE_PRICE_PROFESSIONAL_ACCESS_ANNUAL || '',
    stripePriceIdInstallment: process.env.STRIPE_PRICE_PROFESSIONAL_ACCESS_INSTALLMENT || '',
    searchRankBoost: 2.0,
    mapHighlight: true,
    listingPlacement: true,
...
// ============================================================================
// PROFESSIONAL PLAN PRICING SUMMARY
// ============================================================================
// Both Contractors and Companies receive identical Professional Access.
// Profile page formats differ; entitlements do NOT.
// Verification is INCLUDED in Professional Access pricing.
//
// INSTALLMENT OPTION: $1,500 every 5 months
//   - 3 payments per year = $4,500 total annual cost
//   - Auto-renews every 5 months
//   - Higher total cost than annual prepay
//
// ANNUAL PREPAY (PREFERRED): $2,500 per year
//   - Saves $2,000 compared to installment option
//   - Best value for committed professionals
//   - Single annual payment
//
// ============================================================================
// CONTRACTOR VERIFICATION — LEGACY (Now included in Professional Plan)
// ============================================================================
// NOTE: Verification is now INCLUDED in the Professional Plan.
